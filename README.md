...
- **Tablet Android dei meccanici:** apri lo stesso indirizzo in Chrome ed entra con l’account personale del meccanico. Dopo l’accesso si apre una postazione touch separata dal gestionale, a schermo intero su richiesta, con le sole lavorazioni assegnate, timer personale in evidenza, note, richieste ricambi e accesso alle foto. Più tablet possono lavorare insieme; il timer è sempre attribuito alla persona che ha fatto accesso.
